...
class ErrorPolicy
{
     ...
     *
     * @param  \Nidavellir\Cube\Models\User  $user
     * @param  \Nidavellir\Cube\Models\Error  $model
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Error $model)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Error $model)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Error $model)
    {
        return true;
    }
}
